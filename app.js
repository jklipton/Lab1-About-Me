...
if (dreamTemp.toLowerCase() === 'yes' || myDream.toLowerCase() === 'y'){
...
if (dreamHemi.toLowerCase() === 'yes' || myDream.toLowerCase() === 'y'){
...
if (dreamSki.toLowerCase() === 'yes' || myDream.toLowerCase() === 'y'){
...
if (userJoin.toLowerCase() === 'yes' || myDream.toLowerCase() === 'y')    {
